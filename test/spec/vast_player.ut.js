    ...
    describe('static:', function() {
        describe('properties:', function() {
            describe('vpaidSWFLocation', function() {
                it('should be "https://cdn.jsdelivr.net/npm/vast-player@_VERSION_/dist/vast-player--vpaid.swf"', function() {
                    expect(VASTPlayer.vpaidSWFLocation).toBe('https://cdn.jsdelivr.net/npm/vast-player@_VERSION_/dist/vast-player--vpaid.swf');
